...
app = Flask(__name__) # Load HTML pages

@app.route('/')
def index():  # put application's code here
    # loads the main page of the website. :return: main page of website
    
    return render_template('discover.html', layout=None)


@app.route('/login', methods=['GET', 'POST'])
def login():
    # login method for login page - loads login page and input from login form. :return: login page
    ...
    return render_template('login.html', layout=None)


@app.route('/register', methods=['GET', 'POST'])
def register():
    # loads the register page of the websire. :return: register page
    
    return render_template('register.html', layout=None)


@app.route('/discover', methods=['GET', 'POST'])
def discover():
    # disover page/main page of website. :return: discover/main page
...
def recipe():
    # loads the recipe page of website. :return: recipe page
    
    return render_template('recipe.html', layout=None)


@app.route('/recipeCreator', methods=['GET', 'POST'])
def recipeCreator():
    # loads the recipe creator page of website. Where a user can create recipes and 'POST' it to the JSON file. :return: recipe creator page
    
    return render_template('recipeCreator.html', layout=None)
...
def delete_recipe(recipeId):
    ...
    # Find recipe in JSON using recipeId, create new list with all but specified recipe, overwrite file. :return updated json object
...
def users():
    ...
    # gets users from the users.json file :return: json object
