 ...
 * This allows the user to create or edit recipes on the website.
 */


/**
 * LoadContent()
 * Either loads a recipe, or will load all user recipes.
 */
...
/**
 * PopulateRecipe()
 * Gets the details for the recipe and displays it on the page.
 */
...
/**
 * DeleteTableRow()
 * This function lets the user delete rows from any of the tables.
 ...
 * This is done by either creating a new recipe object, or overwriting an existing recipe object.
 */
function SaveRecipe()
{
    // Get recipe data.
